...
import {
  ...
  getMyTrainee, getTrainingEnrollments, getTrainingPrograms, updateTrainee,
...
export default function TraineeDashboard() {
  ...
  const load = async () => {
    ...
    try {
      const traineeResponse = await getMyTrainee();
